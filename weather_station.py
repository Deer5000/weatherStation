...
class StatisticsDisplay:
    ...
    def display(self):
        #Temp
        print("Min temp:", min(self.temps))
        print("Average temp:", sum(self.temps)/len(self.temps))
        print("Max temp:", max(self.temps))
        #humidity
        ...
        #Pressure
        print("Min pressure:", min(self.pressure))
        print("Average pressure:", sum(self.pressure)/len(self.pressure))
        print("Max pressure:", max(self.pressure))
...
class ForecastingDisplay:
    ...
    def display(self):
        print("Forecast temps: ", self.forecast_temp,
